...
pub const SystemdDropIn = service_schema.SystemdDropIn;
pub const ServiceEnvFile = service_schema.ServiceEnvFile;
...
pub const CronSourceKind = service_schema.CronSourceKind;
...
pub const SshHostKeyFact = user_schema.SshHostKeyFact;
...
pub const ResourceKind = resource_schema.ResourceKind;
pub const ResourceSensitivity = resource_schema.ResourceSensitivity;
pub const ResourceDefaultAction = resource_schema.ResourceDefaultAction;
pub const ResourceRef = resource_schema.ResourceRef;
pub const ResourceInventory = resource_schema.ResourceInventory;
...
test "inventory json without dev_env uses empty default" {
    ...
    try std.testing.expectEqual(@as(usize, 0), parsed.value.modules.services.drop_ins.len);
    try std.testing.expectEqual(@as(usize, 0), parsed.value.modules.services.env_files.len);
    ...
    try std.testing.expectEqual(@as(usize, 0), parsed.value.modules.ssh.host_keys.len);
    try std.testing.expectEqual(@as(usize, 0), parsed.value.modules.resources.resources.len);
    try std.testing.expect(!parsed.value.modules.resources.truncated);
